...
2. **Variance analysis.** Identify what is stable vs. what is likely to change. In this product the fixed 2018–2025 window and the two dataset IDs are stable; the *set of series* rendered (raw, casualty-filtered, arrests, per-borough) is the axis that varies.
